...
export default function Marquee({ text = '', rotate = 0, base = 32, variant = 'ribbon' }) {
  ...
  return (
    <div aria-hidden="true" style={{ position: 'relative', transform: `rotate(${rotate}deg)`, margin: isRibbon ? '-48px -40px 24px' : '24px -40px', borderTop: '1px solid #E8E3D6', borderBottom: '1px solid #E8E3D6', padding: isRibbon ? '15px 0' : '14px 0', overflow: 'hidden' }}>
