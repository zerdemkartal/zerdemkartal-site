...
import { INSTAGRAM_URL, SITE, ORG, WEBSITE, YOUTUBE_URL, pageMeta } from '@/lib/site';
...
export default async function Hakkimda() {
  ...
  const jsonld = { '@context': 'https://schema.org', '@graph': [
    ...
    { '@type': 'Person', '@id': SITE + '/#astrolog', name: 'zerdemkartal', jobTitle: 'Astrolog', worksFor: { '@id': SITE + '/#org' }, sameAs: [INSTAGRAM_URL, YOUTUBE_URL] },
